...
import com.divudi.facade.PersonContactFacade;
...
//
    ...
    public DataModel<Institution> getInstitutions() {
        String temSQL;
        temSQL = "SELECT i FROM Institution i WHERE i.retired=false ";
    ...
    public DataModel<Unit> getUnits() {
        String temSql;
            ...
            temSql = "select u from Unit u where u.retired=false order by u.name";

...
import org.pemis.entity.ItemUnit;
...
import org.pemis.facade.AppImageFacade;
import org.pemis.facade.CategoryFacade;
import org.pemis.facade.InstitutionFacade;
import org.pemis.facade.ItemFacade;
import org.pemis.facade.ItemUnitFacade;
...
public class ImageController implements Serializable {
    ...
    public StreamedContent getScImageById() {
        ...
        if (context.getRenderResponse()) {
            ...
            Image temImg = getAppImageFacade().find(Long.valueOf(id));
    ...
    public List<Image> getAppImages() {
        if (appImages == null) {
    ...
    public void setAppImages(List<Image> appImages) {
    ...
    public void dispplayUnitImages() {
        ...
        List<Image> lstImgs = getAppImageFacade().findBySQL("Select ai from AppImage ai Where ai.unit.id = " + getUnit().getId());
        System.out.println("Going to array");
        for (Image ai : lstImgs) {
